...
function secJoin(dataHomeJoin) {
  ...
  htmlHome2 += '<img src="images/climbers.png" alt="Alternate Text" />';
  htmlHome2 += '<section>';
...
function secMiscMem(dataHomeMembers) {
  ...
  for (var i = 0; i < dataHomeMembers.events.length; i++) {
    htmlHome3 += '<div><h5>' + dataHomeMembers.events[i].title + '</h5>';
    htmlHome3 += '<img src="images/calendar-2.png" alt="calendar" />';

    htmlHome3 += '<p>' + dataHomeMembers.events[i].text + '</p></div><br />';
  }
  htmlHome3 += '</section>';
...
function secMiscMEvents(dataHomeMEvents) {
  ...
  for (var i = 0; i < dataHomeMEvents.hikers.length; i++) {
    htmlHome4 += '<div><img src="' + dataHomeMEvents.hikers[i].imageURL + '"';
    htmlHome4 += 'alt="' + dataHomeMEvents.hikers[i].subtitle + '"/>';

    htmlHome4 +=
      '<p><strong>' +
      dataHomeMEvents.hikers[i].firstname +
      ' ' +
      dataHomeMEvents.hikers[i].lastname +
      '</strong>';
    htmlHome4 +=
      '<br />' +
      dataHomeMEvents.hikers[i].city +
      ', ' +
      dataHomeMEvents.hikers[i].state +
      '</p></div>';
  }
  htmlHome4 += '</section>';
...
function secMiscAbout(dataHomeAbout) {
  ...
  htmlHome5 += '<div><h5>' + dataHomeAbout.about.title + '</h5>';
  htmlHome5 += '<p>' + dataHomeAbout.about.text + '</p></div>';
  htmlHome5 += '</section>';
...
function secALevel3(data3) {
  ...
  htmlArticle3 += '<img src="/images/white.jpg" alt="Alternate Text" />';
  ...
  htmlArticle3 += '<img src="/images/File_001.png" alt="Alternate Text" />';
  htmlArticle3 += '<article>';
...
function secALevel4(data4) {
  ...
  htmlArticle4 +=
    '<img src="/images/forest-grass-lawn-1826.jpg" alt="Alternate Text" />';
  htmlArticle4 += '<article>';
  ...
  htmlArticle4 += '<article>';
  htmlArticle4 +=
    '<img src="/images/fall-background-photo.jpg" alt="Alternate Text" />';
  htmlArticle4 += '<article>';
...
function secRotate(dataEvents) {
  ...
  htmlEvents += '<section>';
  htmlEvents += '<img src="images/File_011.png" alt="Alternate Text" />';
...
function secToday(dataEvents2) {
  ...
  var imageArray = [
    '/images/sunnytrees.png',
    '/images/File_017.png',
    '/images/File_016.png',
    '/images/crystalriver.png',
    '/images/photo-1507041957456-9c397ce39c97.jpg',
    '/images/File_013.png',
  ];
