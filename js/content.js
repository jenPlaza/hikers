...
function secMiscMem(dataHomeMembers) {
  ...
  for (var i = 0; i < dataHomeMembers.events.length; i++) {
    ...
    htmlHome3 +=
      '<p><strong>' + dataHomeMembers.events[i].title + '</strong></p>';
...
function secALevel1(data1) {
  ...
  var imageArray = [
    '/HikersGuide/design/File_005.png',
    '/HikersGuide/design/File_010.png',
    '/HikersGuide/design/File_015.png',
    '/HikersGuide/design/File_012.png',
    '/HikersGuide/design/File_013.png',
    '/HikersGuide/design/File_014.png',
    '/HikersGuide/design/File_018.png',
  ];
...
function secRotate(dataEvents) {
  ...
  htmlEvents += '<section>';
  htmlEvents +=
    '<img src="HikersGuide/design/File_011.png" alt="Alternate Text" />';
...
function secToday(dataEvents2) {
  ...
  var imageArray = [
    '/HikersGuide/design/sunnytrees.png',
    '/HikersGuide/design/File_017.png',
    '/HikersGuide/design/File_016.png',
    '/HikersGuide/design/crystalriver.png',
    '/HikersGuide/design/photo-1507041957456-9c397ce39c97.jpg',
    '/HikersGuide/design/File_013.png',
  ];
...
function secThisMonth(dataEvents4) {
  ...
  var imageArray = [
    ...
    '/HikersGuide/design/File_012.png',
    '/HikersGuide/design//File_018.png',
    '/HikersGuide/design/File_019.png',
  ];
