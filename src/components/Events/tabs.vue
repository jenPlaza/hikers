  ...
  <div>
    ...
    <section id="tab">
      <button
        ...
        @click="openTab(event, 'ThisMonth')"
      >
        Today
      </button>
      <button id="12" class="tablinks" @click="openTab(event, 'Weekend')">
        Weekend
      </button>
      <button id="3" class="tablinks" @click="openTab(event, 'Today')">
        This Month
      </button>
    </section>
